...
{
    public class EfDistrictDal : EfEntityRepositoryBase<District,RealEstateDbContext> , IDistrictRepository
    {
        public EfDistrictDal(RealEstateDbContext context) : base(context)
        {
        }
    }
}
