...
{
    public class EfStatusDal : EfEntityRepositoryBase<Status,RealEstateDbContext>,IStatusRepository
    {
        public EfStatusDal(RealEstateDbContext context) : base(context)
        {
        }
    }
}
