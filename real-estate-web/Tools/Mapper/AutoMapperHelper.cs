...
namespace real_estate_web.Tools.Mapper
{
    public class AutoMapperHelper : Profile
    {
        public AutoMapperHelper()
        {
            ...
            CreateMap<ListingWebsiteScrapingLibrary.Models.v3.PropertyListing, PropertyListingDetail>().ForMember(dest => dest.ListingLink , mem => mem.MapFrom(src=> src.ListiningLink));
        }
    }
}
